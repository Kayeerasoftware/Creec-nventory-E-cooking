...
<body id="dashboard">
    <!-- Top Navigation Bar -->
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" style="background: linear-gradient(90deg, #140168 0%, #5039d6 100%); z-index: 9999;">
        <div class="container-fluid d-flex justify-content-between align-items-center">
            <div class="d-flex align-items-center">
                ...
                <div class="d-flex align-items-center me-3">
                    ...
                    <button class="btn btn-link navbar-text d-none d-md-block" style="font-size: 1.2em; color: #ff8c00; font-weight: bold; border: none; outline: none; background: linear-gradient(90deg, rgba(20,1,104,0.3) 0%, rgba(80,57,214,0.3) 100%);" type="button" data-bs-toggle="modal" data-bs-target="#chatModal"><i class="fas fa-headset me-2" style="color: #ff8c00;"></i>CREEC Support</button>
                    <button class="btn btn-link navbar-text d-md-none" style="font-size: 1.2em; color: #ff8c00; font-weight: bold; border: none; outline: none; background: linear-gradient(90deg, rgba(20,1,104,0.3) 0%, rgba(80,57,214,0.3) 100%);" type="button" data-bs-toggle="modal" data-bs-target="#chatModal"><i class="fas fa-headset" style="color: #ff8c00;"></i></button>
                </div>
            </div>
            <button class="navbar-brand mx-auto btn btn-link d-none d-md-block" style="font-size: 1.2em; border: none; outline: none; background: linear-gradient(90deg, rgba(20,1,104,0.3) 0%, rgba(80,57,214,0.3) 100%);" type="button">
                <i class="fas fa-tools"></i> E-Cooking Spare Parts Inventory Management System
            </button>
            <button class="navbar-brand mx-auto btn btn-link d-md-none" style="font-size: 1.2em; border: none; outline: none; background: linear-gradient(90deg, rgba(20,1,104,0.3) 0%, rgba(80,57,214,0.3) 100%);" type="button">
                <i class="fas fa-tools"></i>
            </button>
            <div class="navbar-nav d-flex align-items-center gap-2">
                <div class="text-center" style="color: #ffe66d; font-size: 0.6rem; line-height: 1.2; margin-top: -5px; white-space: nowrap;">
                    <div><span id="realtimeDate"></span> <span id="realtimeTime"></span></div>
                </div>
                <div class="dropdown">
                    <button class="btn btn-link dropdown-toggle d-flex align-items-center" style="color: #ffe66d; text-decoration: none; border: none; outline: none; background: linear-gradient(90deg, rgba(20,1,104,0.3) 0%, rgba(80,57,214,0.3) 100%); padding: 2px 10px; border-radius: 8px;" type="button" id="userDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                        <div class="bg-warning rounded-circle d-flex align-items-center justify-content-center" style="width: 28px; height: 28px; flex-shrink: 0; overflow: hidden;">
                        ...
                        <div class="d-none d-md-block text-start ms-2">
                            <div style="font-size: 0.7rem; opacity: 0.8; line-height: 1;">Welcome back</div>
                            <div style="font-size: 0.85rem; font-weight: bold; line-height: 1.2;">{{ $user->name }}</div>
                        </div>
                    </button>
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown" style="min-width: 250px;">
                        <li class="px-3 py-2 border-bottom">
                            <div class="d-flex align-items-center">
                                <div class="bg-primary rounded-circle d-flex align-items-center justify-content-center me-3" style="width: 50px; height: 50px; overflow: hidden;">
                                    @if($user->profile_picture)
                                        <img src="{{ asset('storage/' . $user->profile_picture) }}" alt="{{ $user->name }}" style="width: 100%; height: 100%; object-fit: cover;">
                                    @else
                                ...
                                <div>
                                    ...
                                    <span class="badge bg-success mt-1">{{ ucfirst($userRole ?? 'User') }}</span>
                                </div>
                            </div>
                        </li>
        ...
        <div class="offcanvas-body d-lg-block d-flex flex-column" style="padding-bottom: 0; position: relative;">
            ...
            <div class="px-2 mb-2">
                <span class="d-flex align-items-center">
                    <i class="fas fa-user-check me-1 text-success" style="font-size: 0.7rem;"></i>
                    <span class="fw-bold text-success" style="font-size: 0.7rem;">Logged in</span>
                </span>
            </div>
            <div class="px-2 mb-2">
                <span class="d-flex align-items-center">
                    <i class="fas fa-shield-alt me-1 text-primary" style="font-size: 0.7rem;"></i>
                    <span class="fw-bold text-primary" style="font-size: 0.6rem;">Authenticated</span>
                </span>
            </div>
            <div style="flex: 1;">
            ...
            <div class="px-2 mb-2">
                <span class="d-flex align-items-center">
                    <i class="fas fa-users-cog me-1 text-warning" style="font-size: 0.7rem;"></i>
                    <span class="fw-bold text-warning" style="font-size: 0.7rem;">{{ ucfirst($userRole ?? 'User') }} Panel</span>
                </span>
            </div>
            <div class="px-2 mb-2">
                <span class="d-flex align-items-center">
                    <i class="fas fa-lock-open me-1 text-success" style="font-size: 0.7rem;"></i>
                    <span class="fw-bold text-success" style="font-size: 0.7rem;">{{ $userRole === 'admin' ? 'Full access' : 'Half access' }}</span>
                </span>
            </div>

                <form action="/logout" method="POST" style="display: inline;">
                    @csrf
                    <button type="submit" class="nav-link text-danger fw-bold" style="background: none; border: none; width: 100%; text-align: left; cursor: pointer;">
            ...
            <!-- User Profile Box -->
            <div class="px-2 mb-2">
                <div class="card" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border: none; padding: 12px; margin: 0; border-radius: 10px;">
                    <div class="text-center">
                        <div class="bg-white rounded-circle d-inline-flex align-items-center justify-content-center mb-2" style="width: 50px; height: 50px; overflow: hidden;">
                            @if($user->profile_picture)
                                <img src="{{ asset('storage/' . $user->profile_picture) }}" alt="{{ $user->name }}" style="width: 100%; height: 100%; object-fit: cover;">
                            @else
                                <i class="fas fa-user" style="font-size: 1.5rem; color: #667eea;"></i>
                            @endif
                        </div>
                        <div class="fw-bold text-white text-truncate" style="font-size: 0.9rem; line-height: 1.3;">{{ $user->name }}</div>
                        <div class="badge bg-warning text-dark mt-1" style="font-size: 0.65rem;">{{ ucfirst($userRole ?? 'User') }}</div>
                    </div>
                </div>
            </div>

            <!-- Support Chat Button -->
            <div class="px-2 pb-3 mb-2">
                <button class="btn btn-success w-100 d-flex align-items-center justify-content-center position-relative" data-bs-toggle="modal" data-bs-target="#chatModal" style="border: none; border-radius: 8px; padding: 10px 15px; font-size: 0.9rem; font-weight: 600; box-shadow: 0 2px 4px rgba(40,167,69,0.3); transition: all 0.2s ease;" onmouseover="this.style.transform='translateY(-1px)'; this.style.boxShadow='0 4px 8px rgba(40,167,69,0.4)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 2px 4px rgba(40,167,69,0.3)'">
                    <i class="fas fa-comments me-2"></i>
                    <span>Support Chat</span>
                    <span class="position-absolute top-0 end-0 translate-middle p-1 bg-danger border border-light rounded-circle" style="width: 10px; height: 10px;"></span>
                </button>
            </div>
    ...
    @include('chat_modal')
    @include('partials.edit-technician-form')
    @include('partials.edit-trainer-form')
