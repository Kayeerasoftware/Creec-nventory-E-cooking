    ...
    <nav class="navbar navbar-dark fixed-top" style="background: linear-gradient(90deg, #140168 0%, #5039d6 100%); z-index: 9999; padding: 0.2rem 0.3rem; min-height: 45px;">
        <div class="container-fluid d-flex justify-content-between align-items-center" style="gap: 0.2rem; flex-wrap: nowrap;">
            ...
            <div class="d-none d-md-block" style="flex-grow: 1; text-align: center;">
                <span style="font-size: 1em; color: white;"><i class="fas fa-tools"></i> Technician Home</span>
            </div>
            <div class="navbar-nav d-flex align-items-center flex-row" style="gap: 0.2rem; flex-shrink: 0; flex-wrap: nowrap;">
                <a href="/technician/home" class="btn btn-sm btn-outline-light me-2">
                    <i class="fas fa-tachometer-alt"></i> <span class="d-none d-md-inline">Dashboard</span>
                </a>
                <a href="/technician/panel" class="btn btn-sm btn-outline-light me-2">
                    <i class="fas fa-user-circle"></i> <span class="d-none d-md-inline">Panel</span>
                </a>
                ...
                @auth
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end shadow-lg" style="border-radius: 10px; border: none; min-width: 200px;">
                            ...
                            <li><a class="dropdown-item" href="/technician/profile"><i class="fas fa-user-edit me-2"></i>My Profile</a></li>
            ...
            <div class="px-2 mb-2">
                <div class="card" style="background: #f8f9fa; border: 1px solid #dee2e6; padding: 8px; margin: 0;">
                    <div class="d-flex align-items-center">
                        <div class="@auth bg-{{ auth()->user()->role === 'admin' ? 'danger' : (auth()->user()->role === 'trainer' ? 'warning' : 'info') }} @else bg-secondary @endauth rounded-circle d-flex align-items-center justify-content-center me-2" style="width: 40px; height: 40px; min-width: 40px; overflow: hidden;">
                            @auth
                                @if(auth()->user()->image)
                        ...
                        <div class="card shadow-sm border-0" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
                            <div class="card-body p-3">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col">
                                        <h5 class="text-white mb-1">My Profile</h5>
                                        <p class="text-white-50 mb-0 small">Update your personal information, contact details, and profile photo</p>
                                    </div>
                                    <div class="col-auto">
                                        <a href="/technician/profile" class="btn btn-light">
