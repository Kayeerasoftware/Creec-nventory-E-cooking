    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" style="background: linear-gradient(90deg, #140168 0%, #5039d6 100%); z-index: 9999;">
        <div class="container-fluid d-flex justify-content-between align-items-center">
            ...
            <div class="navbar-nav">
                <a href="/login" class="btn btn-link navbar-text d-none d-md-block" style="font-size: 1.2em; color: #ffe66d; border: none; outline: none; background: linear-gradient(90deg, rgba(20,1,104,0.3) 0%, rgba(80,57,214,0.3) 100%); text-decoration: none;"><img src="/pictures/Power Cord.png" alt="Icon" style="width: 40px; height: 40px; margin-right: 8px;">Manage Your Workshop</a>
                <a href="/login" class="btn btn-link navbar-text d-md-none" style="font-size: 1.2em; color: #ffe66d; border: none; outline: none; background: linear-gradient(90deg, rgba(20,1,104,0.3) 0%, rgba(80,57,214,0.3) 100%); text-decoration: none;"><img src="/pictures/Power Cord.png" alt="Icon" style="width: 40px; height: 40px;"></a>
            </div>
        </div>
    </nav>
        ...
        <div class="offcanvas-body d-lg-block d-flex flex-column" style="padding-bottom: 0; position: relative;">
            ...
            <div class="px-2 mb-2">
                <div class="card" style="background: #f8f9fa; border: 1px solid #dee2e6; padding: 8px; margin: 0;">
                    <div class="d-flex align-items-center">
                        <div class="bg-secondary rounded-circle d-flex align-items-center justify-content-center me-2" style="width: 40px; height: 30px; min-width: 30px;">
                            <i class="fas fa-user text-white" style="font-size: 0.8rem;"></i>
                        </div>
                        <div class="flex-grow-1" style="min-width: 0;">
                            <div class="fw-bold text-dark" style="font-size: 0.85rem; line-height: 1.2;">Guest User</div>
                            <div class="text-muted" style="font-size: 0.7rem; line-height: 1.2;">No Role</div>
                        </div>
                    </div>
                </div>
            </div>
